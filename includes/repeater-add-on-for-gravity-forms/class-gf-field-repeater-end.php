...
//			if (empty($remove_html)) { $remove_html = "<img class=\"gf_repeater_remove_default\" alt=\"-\" src=\"data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\">"; }
			...
			if (empty($add_html)) { $add_html = "<input type='button' class='button' value='Add Individual' />"; }
			if (empty($remove_html)) { $remove_html = "<input type='button' class='button' value='Remove Individual' />"; }
