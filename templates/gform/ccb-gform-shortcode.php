<div class="ccb-gform">
    <div class="ccb-login-form-section">
        <?php echo $this->output('gform_login'); ?>
    </div>
    ...
    <div class="ccb-user-reg-form-section">
        <?php echo $this->output('gform_user'); ?>
    </div>
...
<script type="text/javascript">
    ...
    (function ($) {
        ...
        jQuery(document).bind('gform_post_render', function (event, form_id, current_page) {
            ...
            if (all_ccb_form[form_id] == 'individual_profile_from_login_password') {
            ...
            else if (all_ccb_form[form_id] == 'add_individual_to_event') {
